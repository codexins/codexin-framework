...
$reveal_archive_layout  = !empty( codexin_option('reveal-blog-layout') ) ? codexin_option('reveal-blog-layout') : 'right';
                ...
                <?php 
                    ...
                    ?>
                        <div id="primary" class="site-main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/WebPageElement">
                            <?php echo ( ( codexin_option( 'reveal_post_style' ) == 'grid' ) ) ? '<div class="blog-grid-wrapper"><div class="row">' : '<div class="blog-list-wrapper">' ; ?>
                                <?php reveal_loop(); ?>
                            <?php echo ( ( codexin_option( 'reveal_post_style' ) == 'grid' ) ) ? '</div></div>' : '</div>' ; ?>                                
