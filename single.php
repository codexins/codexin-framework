...
$reveal_single_layout           = !empty( codexin_option( 'reveal-single-layout' ) ) ? codexin_option( 'reveal-single-layout' ) : 'right';
                        ...
                        <div id="primary" class="site-main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/WebPageElement">
                            ...
                            <?php
                                ...
                                while ( have_posts() ) : the_post();
                                    ...
                                    if( codexin_option( 'reveal_single_button' ) ):
                                        reveal_post_link();
                                    endif;

                                    if( codexin_option( 'reveal_post_comments' ) ):
